  ...
  return (
    <>
      <div className="about-service p-20">
        ...
        {showAllServices ? (
          <button className="text-xl mt-4 p-4 text-justify border border-color2 flex items-center bg-color1 hover:bg-color6 hover:border-color1 text-white" onClick={toggleShowAllServices}>See Less Services</button>
        ) : (
          <button className="text-xl mt-4 p-4 text-justify border border-color2 flex items-center bg-color1 hover:bg-color6 hover:border-color1 text-white" onClick={toggleShowAllServices}>See More Services</button>
        )}
      </div>
    </>
  );
