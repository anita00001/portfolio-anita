...
//   return (
//     <div className="min-h-screen bg-color4 grid grid-cols-2 gap-4 px-20 py-20">

//       {/* Left Side: Photo/Video */}
//       <div className="relative m-20 w-80 h-80">
//         <div className="bg-color1 rounded-lg p-4 shadow-lg bg-blue-200">
//           {view === 'photo' ? (
//             <img
//               src={featuredImage}
...
//             className="text-xl mt-4 px-4 py-2 text-justify rounded-lg shadow-md border border-color2 flex items-center bg-color1 hover:bg-color6 hover:border-color1 text-white"
//           >
//             See Photo
//           </button>
//           <button
...
//       <div classname="mt-20">
//         <h1 className="py-10 text-4xl font-bold text-gradient">Featured Project</h1>
//         <p className="text-xl py-4 text-justify mb-10">
//           This project is an e-commerce platform designed to provide seamless shopping experiences
//           for users. It integrates front-end, back-end, and database technologies.
//         </p>
//         <div className="mb-4">
...
const FeaturedProject = () => {
  ...
  return (
    <div className="min-h-screen bg-color4 grid grid-cols-2 gap-10 px-20 py-20 items-center">
      {/* Left Side: Photo/Video */}
      <div className="relative  m-20 w-80 h-80">
      ...
      <div className="flex flex-col justify-start mt-10">
        <h1 className="text-4xl font-bold text-gradient mb-6">Featured Project</h1>
        <div
